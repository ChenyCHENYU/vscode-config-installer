...
module.exports = {
  scopes: [
    { value: 'editors', name: 'editors:   编辑器注册表' },
    { value: 'installer', name: 'installer: 安装逻辑' },
    { value: 'cli', name: 'cli:       命令行界面' },
    { value: 'status', name: 'status:    状态检查' },
    { value: 'backup', name: 'backup:    备份恢复' },
    { value: 'uploader', name: 'uploader:  配置上传' },
    { value: 'ui', name: 'ui:        界面组件' },
